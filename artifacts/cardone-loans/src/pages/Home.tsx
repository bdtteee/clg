        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { icon: User, iconBg: "bg-secondary/20", iconColor: "text-secondary", title: "Personal Loan", subtitle: "Flexible USD for significant personal needs.", range: "$10,000 – $50,000 USD", fee: "KES 2,600 (~$20)", badge: "85% Pre-approved", features: ["Instant 85% pre-qualification", "Flexible repayment schedule", "Personal use"] },
              { icon: Briefcase, iconBg: "bg-accent/20", iconColor: "text-accent", title: "Business Loan", subtitle: "Major capital for African enterprise growth.", range: "$20,000 – $100,000 USD", fee: "KES 6,500 (~$50)", badge: "85% Pre-approved", features: ["Instant 85% pre-qualification", "Business expansion ready", "Most popular product"], highlight: true },
            ].map((product, i) => (
